  ...
  if(isset($_POST['add_veh']))
    {
            ...
            $query="insert into tms_vehicle (v_name, v_pass_no, v_reg_no, v_driver, v_category, v_dpic, v_status, v_price) values(?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssss', $v_name, $v_pass_no, $v_reg_no, $v_driver, $v_category, $v_dpic, $v_status, $v_price);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Vehicle Added";
